...
/**
 * BQAuditInitiateOutputModel
 */
public class BQAuditInitiateOutputModel   {
  private String auditInstanceReference = null;

  private String auditInitiateActionReference = null;

  private Object auditInitiateActionRecord = null;
  ...
  **/
   ...
   * @return auditInitiateActionReference
  **/

  public String getAuditInitiateActionReference() {
    return auditInitiateActionReference;
  }

  public void setAuditInitiateActionReference(String auditInitiateActionReference) {
    this.auditInitiateActionReference = auditInitiateActionReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The Initiate service call input and output record 
   * @return auditInitiateActionRecord
  **/

  public Object getAuditInitiateActionRecord() {
    return auditInitiateActionRecord;
  }

  public void setAuditInitiateActionRecord(Object auditInitiateActionRecord) {
    this.auditInitiateActionRecord = auditInitiateActionRecord;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Audit instance (e.g. initialised, pending, active) 
