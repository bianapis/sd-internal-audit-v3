...
/**
 * BQAuditRequestOutputModel
 */
public class BQAuditRequestOutputModel   {
  ...
  private String auditRequestActionTaskReference = null;

  private Object auditRequestActionTaskRecord = null;

  private String auditRequestRecordReference = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Audit instance request service call 
   * @return auditRequestActionTaskReference
  **/

  public String getAuditRequestActionTaskReference() {
    return auditRequestActionTaskReference;
  }

  public void setAuditRequestActionTaskReference(String auditRequestActionTaskReference) {
    this.auditRequestActionTaskReference = auditRequestActionTaskReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Audit service request record 
   * @return auditRequestRecordReference
  **/

  public String getAuditRequestRecordReference() {
    return auditRequestRecordReference;
  }

  public void setAuditRequestRecordReference(String auditRequestRecordReference) {
    this.auditRequestRecordReference = auditRequestRecordReference;
  }
